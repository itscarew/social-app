...
export default function NotificationCard() {
    ...
    return (
        <div className="bg-white px-5 py-3.5 mb-4 rounded-lg shadow hover:shadow-xl max-w-3xl  transform hover:-translate-y-[0.125rem] transition duration-100 ease-linear">
            <div className="flex items-center justify-between mt-2 rounded-lg px-1 py-1">
                <div className='flex items-center' >
                    ...
                    <div className="ml-3">
                        <span onClick={() => router.push("/dkkfkf")} className="font-semibold tracking-tight text-xs cursor-pointer">John Doe </span>
                ...
                <div onClick={() => router.push(`/post/reeeerrc`)} className="relative flex flex-shrink-0 items-end cursor-pointer">
